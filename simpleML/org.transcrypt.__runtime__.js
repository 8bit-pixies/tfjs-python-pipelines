...
var __envir__ = exports.__envir__ = {};
...
function __nest__(headObject, tailNames, value) {
    ...
    var _loop = function _loop(attrib) {
...
var __proxy__ = exports.__proxy__ = false;
...
var py_metatype = exports.py_metatype = {
    __name__: 'type',
    __bases__: [],
...
function __mergefields__(targetClass, sourceClass) {
    ...
    if (sourceClass[fieldNames[0]]) {
        if (targetClass[fieldNames[0]]) {
            ...
            try {
                for (var _iterator6 = fieldNames[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
...
function __t__(target) {
    return target === undefined || target === null ? false : ['boolean', 'number'].indexOf(typeof target === 'undefined' ? 'undefined' : _typeof(target)) >= 0 ? target : target.__bool__ instanceof Function ? target.__bool__() ? target : false : target.__len__ instanceof Function ? target.__len__() !== 0 ? target : false : target instanceof Function ? target : len(target) !== 0 ? target : false;
}
function float(any) {
    if (any == 'inf') {
        return Infinity;
...
function issubclass(aClass, classinfo) {
    if (classinfo instanceof Array) {
        ...
        try {
            for (var _iterator7 = classinfo[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
...
function callable(anObject) {
    return anObject && (typeof anObject === 'undefined' ? 'undefined' : _typeof(anObject)) == 'object' && '__call__' in anObject ? true : typeof anObject === 'function';
};
...
var bytes = exports.bytes = bytearray;
...
function __jsmod__(a, b) {
    if ((typeof a === 'undefined' ? 'undefined' : _typeof(a)) == 'object' && '__mod__' in a) {
        return a.__mod__(b);
    } else if ((typeof b === 'undefined' ? 'undefined' : _typeof(b)) == 'object' && '__rmod__' in b) {
        return b.__rmod__(a);
    } else {
        return a % b;
    }
...
var BaseException = exports.BaseException = __class__('BaseException', [object], {
    __module__: __name__
});
var Exception = exports.Exception = __class__('Exception', [BaseException], {
    __module__: __name__,
    get __init__() {
        return __get__(this, function (self) {
            var kwargs = dict();
...
var IterableError = exports.IterableError = __class__('IterableError', [Exception], {
    __module__: __name__,
    get __init__() {
...
var StopIteration = exports.StopIteration = __class__('StopIteration', [Exception], {
    __module__: __name__,
    get __init__() {
        return __get__(this, function (self, error) {
...
var ValueError = exports.ValueError = __class__('ValueError', [Exception], {
    __module__: __name__,
    get __init__() {
...
var KeyError = exports.KeyError = __class__('KeyError', [Exception], {
    __module__: __name__,
    get __init__() {
        return __get__(this, function (self, message, error) {
            Exception.__init__(self, message, __kwargtrans__({ error: error }));
...
var AssertionError = exports.AssertionError = __class__('AssertionError', [Exception], {
    __module__: __name__,
    get __init__() {
        return __get__(this, function (self, message, error) {
            if (message) {
...
var NotImplementedError = exports.NotImplementedError = __class__('NotImplementedError', [Exception], {
    __module__: __name__,
    get __init__() {
        return __get__(this, function (self, message, error) {
            Exception.__init__(self, message, __kwargtrans__({ error: error }));
...
var IndexError = exports.IndexError = __class__('IndexError', [Exception], {
    __module__: __name__,
    get __init__() {
        return __get__(this, function (self, message, error) {
            Exception.__init__(self, message, __kwargtrans__({ error: error }));
...
var AttributeError = exports.AttributeError = __class__('AttributeError', [Exception], {
    __module__: __name__,
    get __init__() {
        return __get__(this, function (self, message, error) {
            Exception.__init__(self, message, __kwargtrans__({ error: error }));
...
var py_TypeError = exports.py_TypeError = __class__('py_TypeError', [Exception], {
    __module__: __name__,
    get __init__() {
        return __get__(this, function (self, message, error) {
            Exception.__init__(self, message, __kwargtrans__({ error: error }));
...
var Warning = exports.Warning = __class__('Warning', [Exception], {
    __module__: __name__
});
var UserWarning = exports.UserWarning = __class__('UserWarning', [Warning], {
    __module__: __name__
});
var DeprecationWarning = exports.DeprecationWarning = __class__('DeprecationWarning', [Warning], {
    __module__: __name__
});
var RuntimeWarning = exports.RuntimeWarning = __class__('RuntimeWarning', [Warning], {
    __module__: __name__
});
var __sort__ = exports.__sort__ = function __sort__(iterable, key, reverse) {
...
var sorted = exports.sorted = function sorted(iterable, key, reverse) {
    if (typeof key == 'undefined' || key != null && key.hasOwnProperty("__kwargtrans__")) {
        ;
        var key = null;
    };
...
var map = exports.map = function map(func, iterable) {
    return function () {
        var __accu0__ = [];
...
var filter = exports.filter = function filter(func, iterable) {
    if (func == null) {
        var func = bool;
    }
    return function () {
...
var divmod = exports.divmod = function divmod(n, d) {
    return tuple([Math.floor(n / d), __mod__(n, d)]);
};
var __Terminal__ = exports.__Terminal__ = __class__('__Terminal__', [object], {
    __module__: __name__,
    get __init__() {
        return __get__(this, function (self) {
            self.buffer = '';
...
var __terminal__ = exports.__terminal__ = __Terminal__();
var print = exports.print = __terminal__.print;
var input = exports.input = __terminal__.input;
